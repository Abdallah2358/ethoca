...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('ethoca_alert_updates', function (Blueprint $table) {
            ...
            $table->string('ethoca_id', 25)->comment('The Ethoca ID');
            $table->string('outcome', 50)->comment('The outcome of the alert');
            $table->string('refunded', 50)->comment('The refunded amount'); // can be refactored to tiny int
            $table->boolean('first_party_fraud')->comment('The first party fraud amount');
            ...
            $table->boolean('is_sent')->comment('This flag is raised when the update is sent to ethoca Successfully');
