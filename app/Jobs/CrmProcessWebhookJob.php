...
class CrmProcessWebhookJob extends SpatieProcessWebhookJob
{
    ...
    {
        array_key_exists('ethoca_id', $this->webhookCall->payload) ? $ethoca_id = $this->webhookCall->payload['ethoca_id'] : ''
        ;
        // $ethoca_id = $this->webhookCall->payloadethoca_id;
        try {
            ...
            $this->webhookCall->ethoca_id = $ethoca_id ?? null;
            $this->webhookCall->save();
            throw $th;
        }
