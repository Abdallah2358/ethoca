...
@section('content')
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">Merchant <strong>{{ $merchant->descriptor }}</strong> Alerts Table</div>
            <div class="card-body">
                <table id="myTable" class="display resposive nowrap" >
                    <thead>
                        <th>id</th>
...
@push('scripts')
    ...
    <script>
        const table = $('#myTable');
        table.DataTable({
            ajax: "{{ route('alerts.merchant.data', $merchant->id) }}",
            // paging: true,
            responsive: false,
            // select: true,
            // scrollY: 200,
